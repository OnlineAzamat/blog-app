...
async function AboutPage() {
  ...
  return <div className="max-w-6xl mx-auto">
    <div className="relative mt-24 lg:pt-16 md:pt-12 max-sm:pt-4 flex items-center justify-center flex-col mb-8">
      <h2 className="text-center text-4xl section-title font-sans"><span>About</span></h2>
    ...
    <h1 className="text-center text-4xl font-sans">We are the Aklog, <br /> Team of content writers and designers.</h1>
