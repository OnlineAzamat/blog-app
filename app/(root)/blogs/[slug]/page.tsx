    ...
    <div className="pt-[15vh] max-w-5xl mx-auto">
      ...
      <div className="flex mt-6 gap-6 items-center max-md:flex-col">
        ...
        <div className="flex-1 flex flex-col space-y-4">
          ...
          <p className="line-clamp-2 text-muted-foreground">Thomas Macaulay is a writer based in New York City. He is interested in all things tech, science, and photography related, and likes to yo-yo in</p>
